...
public class SoccerParser {
    ...
    public static final String LOG_TAG = SoccerParser.class.getSimpleName();
    ...
    /**
     * Parses a json to obtain a list of season.
     *
    ...
    /**
     * Parses a json to obtain a list of match.
     *
     * @param result The data retrieved by the service.
    ...
    /**
     * Parses a json to obtain a list of teams.
     *
     * @param result The data retrieved by the service.
     * @return teams.
     */
    ...
    /**
     * Parses a json to obtain a team.
     *
     * @param result The data retrieved by the service.
     * @return team.
     */
